...
import 'package:Homey/screens/devices_pages/unassigned_devices_view_model.dart';
import 'package:flutter/material.dart';
import 'package:hooks_riverpod/hooks_riverpod.dart';
import 'package:material_design_icons_flutter/material_design_icons_flutter.dart';

class UnassignedDevicesPage extends ConsumerWidget {
  const UnassignedDevicesPage({
    super.key,
  });

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final unassignedDevices = ref.watch(unassignedDevicesProvider);
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          'Unassigned devices',
      ...
      body: Column(
        children: [
          if (ref.watch(refreshUnassignedDevicesProvider).isLoading)
            const LinearProgressIndicator(),
          unassignedDevices.when(data: (devices) {
            return Flexible(
              child: ListView(
